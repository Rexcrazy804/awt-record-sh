...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\textwidth]{./Assets/p04.png}
\end{figure}
\newpage
...
\section{Online Application Form}
\subsection{Aim}
\begin{itemize}
...
\subsection{Code}
index.php
\inputminted[frame=lines, breaklines, breakanywhere, numberblanklines=false]{php}{./prog_28/index.php}
create.php
\inputminted[frame=lines, breaklines, breakanywhere, numberblanklines=false]{php}{./prog_28/create.php}
destroy.php
